...
cat <<EOF > type_application_clean_slate_final.py

# this text is placed into python file called "type_application_clean_slate_final.py" using heredoc2 within main bash shell script to generate it.
