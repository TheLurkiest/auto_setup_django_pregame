...
# this code is currently called stage1_auto_d.py in our python code, but for the time being, while I am modularizing in order to test out if we can
# make some changes to it that will allow us to to manipulate our field types within our models.py module in our finished API, I will call it:
# modularized_fieldtype_changer_in_progress.py
...
print('------------------------------------------------------------------')
p_reply = ''
p_reply = input('press ANY KEY to continue automatic default setup if you DIDNT enter a 2nd .csv file.  Enter \'STAGE2\' if you DID enter a 2nd .csv file in order to complete your initial setup of this API.  If you already done this and have tested your API out directly using \'runserver\' you can choose to enter SKIP in order to add new fields to the existing API once this feature has been implemented.  For the time being this last option is still in progress and will be unavailable to the user.')
